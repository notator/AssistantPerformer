 ...
 *
 *  ap/Message.js
 *  The _AP_MIDI_Message namespace which defines the following constructors:
 *
...
importScripts("_AP_MIDI_Constants.js");

var _AP_MIDI_Message = (function ()
{
    "use strict";
    var
    COMMAND = _AP_MIDI_Constants.COMMAND,
    REAL_TIME = _AP_MIDI_Constants.REAL_TIME,
    SYSTEM_EXCLUSIVE = _AP_MIDI_Constants.SYSTEM_EXCLUSIVE,
    ...
    SysExMessage = function (data)
    {
        var i, dataLength = data.length,
            isRealTimeStatus = _AP_MIDI_Constants.isRealTimeStatus;
