...
_AP.inputObjectDef = (function ()
{
    ...
    InputChordDef.prototype.getCCSettings = function(ccSettingsNode, outputTrackPerMidiChannel, nOutputTracks)
    {
    ...
    InputChordDef.prototype.getInputNotes = function(inputNotesNode, outputTrackPerMidiChannel)
    {
