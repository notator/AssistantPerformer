...
MIDILib.track = (function ()
{
    ...
    // Add a moment to the end of this Track.
    // moment.msPositionInScore is used to ensure consecutiveness.
    // A moment can only be appended to the end of the Track.
    // moments are merged if the new moment has the same msPositionInScore as the last moment.
    // An exception is thrown if the new moment's msPositionInScore is less than that of the
    // current last moment in the Track.
    // moment.timestamp is not used in this function.
