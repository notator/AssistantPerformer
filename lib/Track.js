...
MIDI_API.track = (function ()
{
    ...
    // The evt.timestamps are curently set to absolute DOMHRT values.
    ...
    // After saving the recording, the recorded moment.timestamps are
    // discarded, and the evt.timestamps are reset to the values of their
    // original score moment.timestamps. 
