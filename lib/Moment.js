...
MIDI_API.moment = (function ()
{
    ...
    // the moment.timestamp is read only, and is used to revert the contained event.timestamps
    ...
    Moment = function (msPositionInScore)
    {
        ...
        Object.defineProperty(this, "timestamp", { value: msPositionInScore, writable: false });
    ...
    Moment.prototype.mergeMoment = function (moment2)
    {
        ...
        if (moment2.events[0].msPositionInScore !== undefined)
        {
            ...
            Object.defineProperty(this.events[0], "msPositionInScore", { value: moment2.events[0].msPositionInScore, writable: false });
            //the following line effectively deletes moment2.events[0].msPositionInScore;
            moment2.events[0] = MIDI_API.event.getEvent(moment2.events[0].data, moment2.events[0].timestamp);
