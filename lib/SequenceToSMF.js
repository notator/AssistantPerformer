 ...
 *
 *  jiSequenceToSMF.js
 *  The WEB_MIDI_LIB.sequenceToSMF namespace which exposes two public functions
 *
...
WEB_MIDI_LIB.namespace('WEB_MIDI_LIB.sequenceToSMF');

WEB_MIDI_LIB.sequenceToSMF = (function (document, window)
{
    "use strict";
