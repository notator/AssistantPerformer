 ...
 *  illegal.
 *  timestamp is the (floating point) number of milliseconds from the start of the file or performance.
...
MIDI_API.event = (function ()
{
    "use strict";
    var 
    COMMAND = {}, // readonly constants defined below
    RUNNING_STATUS = {}, // readonly constants defined below
    CONTROL = {}, // readonly constants defined below
    SYSTEM_EXCLUSIVE = {}, // readonly constants defined below
    ...
    // Returns either a 1, 2 or 3-byte Event, or a SysExEvent, depending on the data.
    // An exception will be thrown if the data is illegal.
    // data is an array of numbers in range 0..0xF0.
    // timestamp is any number (e.g. wimdow.performance.now()).
    // Note that if this function is being used while reading an input stream, all the
    // timestamp arguments should be relative to some fixed time. They are not, as in
    // Standard MIDI, relative to the previous event.
    ...
    {
        var inBuffer, inDV, outBuffer, outDV, inData,
        values = {};
