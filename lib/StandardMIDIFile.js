...
MIDI_API.standardMIDIFile = (function ()
{
    ...
    //          Event timestamps start at 0 in the sequence.
    //          In Standard MIDI files, timestamps precede their event, and are relative to the previous event.
    ...
    sequenceToSMF = function (sequence, sequenceMsDuration)
    {
        ...
        // The earliest event timestamp is 0. Moment timestamps should be ignored.
