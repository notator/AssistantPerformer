...
MIDILib.constants = (function ()
{
    ...
    CONTROL = {},
    SYSTEM_EXCLUSIVE = {},
    OTHER = {}, // Other constants used by MIDILib objects. These are not standard MIDI constants.
    API =
    {
        COMMAND: COMMAND,
    ...
    // OTHER. Other constants used by the MIDILib objects. These are not standard MIDI constants.
