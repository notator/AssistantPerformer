 ...
 *
 *  lib/Constants.js
 *  The MIDI_API.constants namespace which defines read only constants in the following categories
 *      COMMAND
 *      RUNNING_STATUS
 *      CONTROL
 *      SYSTEM_EXCLUSIVE
...
MIDI_API.namespace('MIDI_API.constants');

MIDI_API.constants = (function ()
{
    "use strict";
    var 
    COMMAND = {},
    ...
    API =
    {
        ...
        ASSISTANT_PERFORMER: ASSISTANT_PERFORMER
    };
    ...
    // ASSISTANT_PERFORMER
    Object.defineProperty(ASSISTANT_PERFORMER, "UNDEFINED_TIMESTAMP", { value: -1, writable: false });
