 ...
 *
 *  jiSequenceToSMF.js
 *  The JI_NAMESPACE.sequenceToSMF namespace which exposes two public functions
 *
...
JI_NAMESPACE.namespace('JI_NAMESPACE.sequenceToSMF');

JI_NAMESPACE.sequenceToSMF = (function (document, window)
{
    "use strict";
