...
function numberArray(numberList)
{
...
function checkFloatRange(numberInput, min, max)
{
...
// its background colour is set to INPUT_ERROR_COLOR and it is given a true boolean jiError attribute.
// Otherwise, the background colour is set to white and jiError is set to null (for garbage collector).
function checkIntRange(numberInput, min, max)
{
	var
...
function setDefaultValueToBlue(numberInput, defaultIntValue)
{
...
function intArrayFromAttribute(nTracks, optsString, attrName, defaultIntValue)
{
	var index,
		valStr,
		rvalString,
